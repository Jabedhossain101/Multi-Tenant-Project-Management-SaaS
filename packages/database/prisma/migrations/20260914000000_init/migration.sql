-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ORG_ADMIN', 'PROJECT_MANAGER', 'TEAM_MEMBER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'MENTION', 'DEADLINE_REMINDER', 'PROJECT_UPDATE', 'ORG_INVITATION', 'BILLING_EVENT', 'AI_REPORT_READY');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('PROJECT_CREATED', 'PROJECT_UPDATED', 'PROJECT_ARCHIVED', 'TASK_CREATED', 'TASK_UPDATED', 'TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'TASK_DELETED', 'COMMENT_ADDED', 'FILE_UPLOADED', 'MEMBER_INVITED', 'MEMBER_JOINED', 'MEMBER_REMOVED', 'SUBSCRIPTION_CHANGED');

-- CreateEnum
CREATE TYPE "AIFeature" AS ENUM ('TASK_ASSISTANT', 'PROJECT_ASSISTANT', 'PRODUCTIVITY_INSIGHTS');
...
CREATE UNIQUE INDEX "Attachment_taskId_fileId_key" ON "Attachment"("taskId", "fileId");
